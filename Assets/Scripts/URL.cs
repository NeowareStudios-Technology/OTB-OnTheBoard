...
public class URL : MonoBehaviour {
    ...
    {
        InAppBrowser.OpenURL("https://api.ontheboard.com/api/v1/accounts/twitterlogin");
    }

    public void openOTBSignUP()
    {
        InAppBrowser.OpenURL("https://app.ontheboard.com/auth/sign-in");
    }
